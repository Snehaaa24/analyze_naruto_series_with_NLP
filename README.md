...
In this project we are going to analyze a series called Naruto. We are going to scrape our own dataset, use zero shot classifiers, build our own LLM text classifier and use NER to build a character network.
